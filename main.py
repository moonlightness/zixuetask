...
import cv2
import sys
from shenghuo import Ui_MainWindow
import paddle
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.label_dic = {'0': 'dryer', '1': 'power', '2': 'watch'}
    ...
    def get_img(self):
        ...
        while (True):
            ...
            cv2.imwrite("test.jpg", frame)  # 拍摄图像的保存路径
            break
        cap.release()
    ...
    def load_image(self, img_path="./test.jpg"):
        '''
        预测图片预处理
        '''
    ...
    def predict(self):
        ...
        model_predict.eval()
        infer_img = self.load_image("test.jpg")
        ...
        text = "样本预测结果为：{}".format(self.label_dic[str(lab)])
        self.textEdit.setText(text)
        print("样本: {},被预测为:{}".format("test.jpg", self.label_dic[str(lab)]))
